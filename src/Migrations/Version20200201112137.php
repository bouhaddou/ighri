 ...
 */
final class Version20200201112137 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE clients ADD maison VARCHAR(255) DEFAULT NULL, ADD pays VARCHAR(255) NOT NULL, ADD postal INT DEFAULT NULL, ADD password VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE clients DROP maison, DROP pays, DROP postal, DROP password');
        $this->addSql('ALTER TABLE comments CHANGE post_id post_id INT DEFAULT NULL, CHANGE rationg rationg INT DEFAULT NULL');
